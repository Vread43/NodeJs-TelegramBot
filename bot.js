...
const bot = new Telegraf('5769283341:AAGPrbFPuvWiPIY2jpMK3NMoPf1oGLitbUs');
...
bot.command('test', ctx => {
    ...
    //file id
     bot.telegram.sendPhoto(ctx.chat.id, 'https://www.sdsd.com/wp-content/uploads/2020/04/New-SDSD.jpg');
});
